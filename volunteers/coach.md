...
- _What should I do if I have the impression a student fully crafted their milestone using AI and do not actually understand the reasoning behind the solution?_ Students are allowed to use AI to enhance and support their learning journey. However it should not replace it. If you sense that a student sole copied content from a GenAI tool without fully grasping what it was about, do ask them to explain to you the reasoning of why they cam eot that specific solution. You can also remind them that AI should be used wisely and cannot substitute their learning. Write in the individual feedback of the student that point so the next coach can check if there is an improvement in the next session. 
